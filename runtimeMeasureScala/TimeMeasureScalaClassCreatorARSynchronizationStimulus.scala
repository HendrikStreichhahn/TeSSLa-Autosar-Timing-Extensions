...
class TimeMeasureScalaClassCreatorARSynchronizationStimulus extends TimeMeasureScalaClassCreator{
	...
	def generateEntireObject(scalaFilePath: String, scalaObjectName: String, resultFilePath: String, repetitionCount: Int,
		...
		var constraintCreator = new TimeMeasureScalaClassCreatorARSynchronizationStimulus
		try {

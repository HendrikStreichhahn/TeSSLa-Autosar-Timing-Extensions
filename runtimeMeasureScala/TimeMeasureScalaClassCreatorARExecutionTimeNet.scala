...
class TimeMeasureScalaClassCreatorARExecutionTimeNet extends TimeMeasureScalaClassCreator{
	...
	def generateEntireObject(scalaFilePath: String, scalaObjectName: String, resultFilePath: String, repetitionCount: Int, eventCount: Int,
		...
		var constraintCreator = new TimeMeasureScalaClassCreatorARExecutionTimeNet
		try {

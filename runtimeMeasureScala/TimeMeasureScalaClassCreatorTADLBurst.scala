...
class TimeMeasureScalaClassCreatorTADLBurst extends TimeMeasureScalaClassCreator{
	...
	def generateEntireObject(scalaFilePath: String, scalaObjectName: String, resultFilePath: String, repetitionCount: Int, eventCount: Int,
			burstLength: Int, maxOccurrences: Int, printInputEvents: Boolean): Boolean= {
		...
		try {
			...
			fileWriter.write("\n");
			burstCreator.generateMeasureConstraint(fileWriter, 1, printInputEvents)
			fileWriter.write("\n");
			...
			fileWriter.write("\n");
			burstCreator.generateOutputFuncValue(fileWriter, 1, printInputEvents)
			fileWriter.write("\n");
			burstCreator.generateOutputFuncFinal(fileWriter, 1, printInputEvents)
			fileWriter.write("\n");

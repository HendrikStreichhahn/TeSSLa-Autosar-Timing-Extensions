...
class TimeMeasureScalaClassCreatorARSynchronizationEventsSingle extends TimeMeasureScalaClassCreator{
	...
	def generateEntireObject(scalaFilePath: String, scalaObjectName: String, resultFilePath: String, repetitionCount: Int,
		...
		var constraintCreator = new TimeMeasureScalaClassCreatorARSynchronizationEventsSingle
		try {
			def maxEventsPerClusterPerStream = 1

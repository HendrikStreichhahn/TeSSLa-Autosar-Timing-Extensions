...
class TimeMeasureScalaClassCreatorTADLOutputSynchronization extends TimeMeasureScalaClassCreator{
	...
	def generateEntireObject(scalaFilePath: String, scalaObjectName: String, resultFilePath: String, repetitionCount: Int,
		...
		var constraintCreator = new TimeMeasureScalaClassCreatorTADLOutputSynchronization
		try {
	...
	protected def generateMemberVariableListExtended(writer: FileWriter, prevTabCount: Int, tolerance: Int, streamCount: Int,
		...
		writer.write(tabs(prevTabCount) + "var traceSet : OutputSynchronizationConstraintGenerator = null" + "\n")
	}
	...
	protected def generateGenerateTrace(writer: FileWriter, prevTabCount: Int, repetitionCount: Int, resultFilePath: String) : Unit = {
		...
		writer.write(tabs(prevTabCount+1) + "traceSet = new OutputSynchronizationConstraintGenerator(streamCount)" + "\n")

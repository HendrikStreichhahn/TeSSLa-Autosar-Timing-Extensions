...
public class TimeMeasureARPeriodicEventTriggering extends TimeMeasureConstraint{
	int period, jitter, minDist;

	public TimeMeasureARPeriodicEventTriggering(int period, int jitter, int minDist){
		this.period = period;
		this.jitter = jitter;

...
public class Event implements Comparable{
	...
	*/
	private Trace ownerStream = null;
	...
	* Constructor.
	* @param timeStamp The Timestamp of the event.
	* @param ownerStream The stream, in which the event occurs.
	*/
	public Event(int timeStamp, Trace ownerStream){
		this.timeStamp = timeStamp;
	...
	* @param ownerStream The stream, in which the event occurs.
	*/
	public Event(int timeStamp, int color, Trace ownerStream){
		this.timeStamp = timeStamp;
		this.color = color;
		this.ownerStream = ownerStream;
	}
	...
	*/
	...
	/**
	* Getter for the stream, in which the event occurs.
	* @return the owner Trace.
	*/
	public Trace getOwnerStream(){
		return ownerStream;
	}

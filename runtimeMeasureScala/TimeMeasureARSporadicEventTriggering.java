...
public class TimeMeasureARSporadicEventTriggering extends TimeMeasureConstraint{
	int lower, upper, jitter;

	public TimeMeasureARSporadicEventTriggering(int jitter, int maxInterArrivalTime, int period){
		this.lower = period;

...
import java.io._
object measureTADL2Order{

	def main(args: Array[String]): Unit = {
		generateTrace()
		measureMultiple(5, "results/TADL2Order.txt")
	}
	...
	var maxDistSource: Int = 50
	var maxDistSourceTarget: Int = 50
	var traceSet : OrderConstraintGenerator = null
	...
	def generateTrace(): Boolean = {
		tesslaMonitorInstance = new TesslaMonitor()
		traceSet = new OrderConstraintGenerator()
		var res: Boolean = traceSet.generateTestTrace(eventCount,  maxDistSource, maxDistSourceTarget)
		if (res) {
			traceSet.initOutput();
		}
		res

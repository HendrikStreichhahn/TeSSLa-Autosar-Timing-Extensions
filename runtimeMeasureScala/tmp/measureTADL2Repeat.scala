...
import java.io._
object measureTADL2Repeat{
	def main(args: Array[String]): Unit = {
		generateTrace()
		measureMultiple(5, "results/TADL2Repeat.txt")
	}
	...
	var upper : Int = 1000
	var span : Int = 50
	var traceSet : RepeatConstraintGenerator = null
	...
	def generateTrace(): Boolean = {
		tesslaMonitorInstance = new TesslaMonitor()
		traceSet = new RepeatConstraintGenerator()
		var res: Boolean = traceSet.generateTestTrace(eventCount, lower, upper, span)
		if (res) {
			traceSet.initOutput();
		}
		res

...
import java.io._
object measureTADL2Periodic{

	def main(args: Array[String]): Unit = {
		generateTrace()
		measureMultiple(5, "results/TADL2Periodic.txt")
	}
	...
	var mimimum : Int = 1
	var jitter : Int = 0
	var traceSet : PeriodicConstraintGenerator = null
	...
	def generateTrace(): Boolean = {
		tesslaMonitorInstance = new TesslaMonitor()
		traceSet = new PeriodicConstraintGenerator()
		var res: Boolean = traceSet.generateTestTrace(eventCount, period, jitter)
		if (res) {
			traceSet.initOutput();
		}
		res

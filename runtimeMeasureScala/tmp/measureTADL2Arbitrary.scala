...
import java.io._
object measureTADL2Arbitrary{

	def main(args: Array[String]): Unit = {
		generateTrace()
		measureMultiple(5, "results/TADL2Arbitrary.txt")
	}
	...
	var minimum: Int = 50
	var maximum: Int = 50
	var stimulusDistance: Int = 25
	var traceSet : ReactionConstraintGenerator = null
	...
	def generateTrace(): Boolean = {
		tesslaMonitorInstance = new TesslaMonitor()
		traceSet = new ReactionConstraintGenerator()
		var res: Boolean = traceSet.generateTestTrace(eventCount, stimulusDistance, stimulusDistance, minimum, maximum)
		if (res) {
			traceSet.initOutput();
		}
		res

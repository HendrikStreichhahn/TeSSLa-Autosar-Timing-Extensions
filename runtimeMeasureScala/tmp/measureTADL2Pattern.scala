...
import java.io._
object measureTADL2Pattern{

	def main(args: Array[String]): Unit = {
		generateTrace()
		measureMultiple(5, "results/TADL2Pattern.txt")
	}
	...
	var period: Int = 50
	var offset = Array(1,2,3,4,5)
	var jitter : Int = 0
	var traceSet : PatternConstraintGenerator = null
	...
	def generateTrace(): Boolean = {
		tesslaMonitorInstance = new TesslaMonitor()
		traceSet = new PatternConstraintGenerator()
		var res: Boolean = traceSet.generateTestTrace(eventCount, period, offset, jitter)
		if (res) {
			traceSet.initOutput();
		}
		res

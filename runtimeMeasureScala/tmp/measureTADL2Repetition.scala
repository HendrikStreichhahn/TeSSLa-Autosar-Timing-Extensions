...
import java.io._
object measureTADL2Repetition{
	def main(args: Array[String]): Unit = {
		generateTrace()
		measureMultiple(5, "results/TADL2Repetition.txt")
	}
	...
	var span : Int = 1
	var jitter : Int = 0
	var traceSet : RepetitionConstraintGenerator = null
	...
	def generateTrace(): Boolean = {
		tesslaMonitorInstance = new TesslaMonitor()
		traceSet = new RepetitionConstraintGenerator()
		var res: Boolean = traceSet.generateTestTrace(eventCount, lower, upper, span, jitter)
		if (res) {
			traceSet.initOutput();
		}
		res

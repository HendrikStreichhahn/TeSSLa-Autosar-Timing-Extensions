...
import java.io._
object measureTADL2StrongSynchronization{
	def main(args: Array[String]): Unit = {
		generateTrace()
		measureMultiple(5, "results/TADL2StrongSynchronization.txt")
	}
	...
	def generateTrace(): Boolean = {
		...
		var res: Boolean = traceSet.generateTestTrace(eventCount,  tolerance, 1,minClusterDistance, maxClusterDistance)
		if (res) {
			traceSet.initOutput();
		}
		res

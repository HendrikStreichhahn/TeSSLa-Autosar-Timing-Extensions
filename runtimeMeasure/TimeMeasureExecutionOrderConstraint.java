...
public class TimeMeasureExecutionOrderConstraint extends TimeMeasureConstraint{
    ...
    */
    public TimeMeasureExecutionOrderConstraint(int eventDistance){
        isOrdinary= true;
    ...
    * @param hierarchWidth
    */
    public TimeMeasureExecutionOrderConstraint(int eventDistance, int hierarchDepth, int hierarchWidth){
        isOrdinary = false;
        this.eventDistance = eventDistance;
